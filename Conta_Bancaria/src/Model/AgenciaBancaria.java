...
public class AgenciaBancaria {
    ...
    public static void operacoes() {
        ...
        switch (operacao) {
            ...
            case 5:
                ...
                break;
            case 6:
                System.out.println("Agradecemos pela sua preferencia!");
                System.exit(0);
    ...
    public static void criarConta() {
        System.out.println("-------------------------------------------------------------");
        System.out.println("---Para criar a conta  precisaremos de algumas informações---");
        System.out.println("-------------------------------------------------------------");
...
//            Instanciando a classe cliente e conta
